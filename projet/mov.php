...
<form action="data_smov.php" method="get" >
        ...
        <p><strong>-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</strong></p>
    <h2>Top 20 Films du moments</h2>
    <?php
        $urlpop = "https://api.themoviedb.org/3/movie/popular?api_key=31062cc6637d51f70564ae9a768049cd&language=fr&page=1";
        ...
        foreach($obj->results as $p){
            ...
            <article>
                <h1> ". $p->title ." </h1>
                <p><strong>".$p->release_date."</strong></p>
                <a href=' data_mov.php?i=". $p->id ."'><img src='".$imgurl_1. $p->poster_path ."' alt='POSTER'/></a>
