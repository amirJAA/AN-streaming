...
<section>
    <?php
        if(isset($_GET['search'])){
            ...
            $urlsearch = "http://api.themoviedb.org/3/search/tv?api_key=31062cc6637d51f70564ae9a768049cd&page=".$_POST['page']."&language=".$_GET['language']."&query=".$nameWithoutSpace;
    ...
    ?>
    <h1>Résultat de la recherche "<?php echo $search ?>" dans nos Séries</h1>
    ...
    <?php
        foreach($objs->results as $results){
            ...
            <article>
                ...
                <a href=' data_ser.php?i=". $results->id ."'><img src='".$imgurl_1. $results->poster_path ."' alt='POSTER'/></a>
